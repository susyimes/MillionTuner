...
package com.george.pitch_estimator.permission;
...
public class RxPermissions {
    ...
    private RxPermissionsFragment getRxPermissionsFragment(@NonNull final FragmentManager fragmentManager) {
        ...
        if (isNewInstance) {
            ...
            // commitNow-> this fix pause exception
        }
        return rxPermissionsFragment;
    }
    ...
    public static void showAlert(FragmentActivity context, String content, int requestCode) {
//        UiUtils.showAlert(context, "授权管理", content, "确定", "取消", new AUNoticeDialog.OnClickPositiveListener() {
//            @Override
//            public void onClick() {
